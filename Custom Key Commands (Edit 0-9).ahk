...
; Control 9 = Add colour grading setup
...
; Search for the Sony Color Balance plugin
ImageSearch, foundX, foundY, 0, 0, %A_ScreenWidth%, %A_ScreenHeight%, SonyColorBalance.png
If(ErrorLevel == 0){
Click, %foundX%, %foundY%
}else{
MsgBox, Sony Color Balance plugin Image not found.
}
Click,
Click,
Click,
...
; Joypad Button 2 (A Button) = Auto Ripple
...
; Joypad Button 5 (Left Bumper) = Scrub Playback Left
...
; Joypad Button 7 (Right Bumper) = Scrub Playback Right
