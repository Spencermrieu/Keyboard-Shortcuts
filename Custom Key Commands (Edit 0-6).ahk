...
IfWinActive, ahk_exe chrome.exe
	...
	; Search for Toggl Icon and click on it
	ImageSearch, foundX, foundY, 0, 0, %A_ScreenWidth%, %A_ScreenHeight%, TogglIcon.png
	If(ErrorLevel == 0){
	Click, %foundX%, %foundY%
	}else{
		ImageSearch, foundX, foundY, 0, 0, %A_ScreenWidth%, %A_ScreenHeight%, TogglIcon2.png
		If(ErrorLevel == 0){
		Click, %foundX%, %foundY%
		}else{
			MsgBox, Toggl Icon Image not found.
		}
	}
